...
// $menu[5] = Posts
/*
$menu[3] = array( __('Lar Legal'), 'lar_legal', 'larlegal.php', '', 'menu-top menu-icon-media', '', 'dashicons-dashboard' );
	$submenu['larlegal.php'][0] = array( __('Lista Processos'), 'upload_files', 'upload.php');
	$submenu['larlegal.php'][1] = array( __('Painel Mangue Vivo'), 'upload_files', 'upload.php');
*/
