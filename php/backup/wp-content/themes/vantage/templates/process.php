...
if (isset($_GET['acao'])) {
    ...
    $iptu_prop = (isset($_GET['iptu_prop'])) ? "true" : "false";
    ...
    if ($id == "NULL") {
        $query = "INSERT INTO  `manguevi_portal_2016`.`wp_sml_lar_legal` (
                    ...
                    `lixo` ,
                    `calcada` ,
                    `tempo_posse`,iptu_pro)
                VALUES (NULL ,  '" . $_GET['lead'] . "',  '" . $_GET['descricao'] . "',  '" . $_GET['endereco'] . "',  '" . $_GET['lat'] . "','" . $_GET['lon'] . "',"
                . " CURRENT_TIMESTAMP ,  '$posse',  '$cv',  '$iptu',  '$app',  '$asfalto',  false,  '$lixo',  '" . $_GET['tempo'] . ",  '$iptu_prop' )";
        ...
        <div data-role="page" data-dialog="true">
            ...
            <form data-ajax="false"  name="processo" style="max-width:100%;min-width:150px" method="get" action="https://manguevivo.org.br/wp/wp-content/themes/vantage/process.php" onsubmit="setLatLon()">
                ...
                <div class="element-input">
                    ...
                    <div class="element-input">
                        <label><input type="checkbox" name="posse"/>Tem escritura de posse?</label>
                    </div>
                    <div class="element-input">
                    ...
                    <div class="element-input">
                        <label><input type="checkbox" name="iptu_prop"/>IPTU está no nome do proprietario?</label>
                    </div>
                    <div class="element-input">
                        <label><input type="checkbox" name="lixo" />Tem serviços de Luz, Água, Coleta de lixo?</label>
                    </div>
                    <div class="element-input">
