...
<div id="tabs">
    ...
    <div id="tabs-23">
        ...
        <h1 style="margin-bottom: 10px;">
            <b>Prefeitura</b><br>
            <small>Dados de seu município</small>
        </h1>
        <p>
            Esta é a tela de cadastro do Lar Legal Prefeitura. Conte um pouco sobre as características de seu município:
        </p>
    ...
    <div id="tabs-1">
        ...
        <form name='perfilUser' style="max-width:100%;min-width:150px" method="get">
            ...
            <div class="title dica"><h2>Dica: Mantenha seus dados de contato sempre atualizados!</h2></div>
            <div class="element-input">
                <label>
                ...
                <form name="processo" style="max-width:100%;min-width:150px" method="get">
                    ...
                    <div id="frmHabitese" class="element-input">
                        ...
                        <div class="element-input" title="Matrícula no registro de imóveis / escritura de posse">
                            <label><input type="checkbox" name="esc_publica"/>O Imóvel tem escritura pública</label>
                        </div>
                        <div class="element-input">
                        ...
                        <div class="element-input">
                            ...
                            <div id="projetos_chk" style="border: 1px;border-color: #34495e;visibility: hidden;display: none;">
                                ...
                                <label><input type="checkbox" name="p_arq" value="a"/>Arquitetônico</label>
                    ...
                    <div id="frmLarLegal" class="element-input">
                        ...
                        <div class="element-input" >
                            <label><input type="checkbox" name="app"/>Área APP ou APL (Área de Preservação Permatente / Área de Preservação Limitada)</label>
                        </div>
                        <div class="element-input" >
                            <label><input  type="checkbox" name="asfalto"/>A rua é Asfaltada ou Calçada</label>
                        </div>

                        <div class="element-input">
                            <label><input type="checkbox" name="lixo"/>Possui serviço de Luz, Água ou Coleta de lixo</label>
                        </div>
                        <div class="element-input">
                    ...
                    <div class="element-input">
                        <label><input type="checkbox" name="iptu_prop"/>O IPTU está no nome do proprietário</label>
                    </div>
                    <br>
                    <div  class="element-input">
