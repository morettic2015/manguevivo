...
<div id="tabs">
    <ul>
        ...
        <li><a href="#tabs-23">Prefeitura</a></li>
    ...
    <div id="tabs-23">
        ...
        <label>
            <input type="checkbox" name="lixo"/>O Município tem área de interesse social
        </label>
        <label>
            <input type="checkbox" name="lixo"/>O Município já realiza parceria com OSCIPS
        </label>
        <div class="element-email">
            <input class="large" type="siconv" name="siconv" placeholder="Cadastro no siconv" value="<?php echo $rperfil[2]; ?>"/>
        </div>
        <label>Imóveis a serem regularizados:
            <select name="fonte">
                <option value='a'>até 1000</option>
                <option value='b'>mais de 1000</option>
            </select>
        </label>
         <label>
             <input type="checkbox" name="lixo"/>O Município tem secretaria de habitação
         </label>
    </div>
    <div id="tabs-1">
            ...
            <div data-role="header">
                ...
                <form name="processo" style="max-width:100%;min-width:150px" method="get">
                    ...
                    <div class="element-input">
                        ...
                        <p>
                        	Conte mais sobre a história do seu imóvel:
                        </p>
                        <textarea class="large" type="text" name="descricao" placeholder="Ex: Terreno recebido de herança; Contrato de compra e venda de 1950" cols="50" rows="5"></textarea>
                        <input type="hidden" name="id" value="<?php echo $id; ?>"/>
                        <input type="hidden" name="pg" value="main"/>
